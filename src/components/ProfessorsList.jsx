      ...
      <div className="border-color-D9D9D9 full-width border-radius-12 py-20 px-28 flex mb-20">
        ...
        <div className="px-20 flex-1">
          ...
          <p className="text-14 text-weight-400 text-595959 mb-18">
            ...
            <span className="text-1F1F1F text-weight-600">{professor.love_teaching_style}%&nbsp;</span> Love Teaching Style
          </p>
          <div className="flex items-center">
            ...
            <div onClick={()=>{
              if(token){
                if(!disableButton){
                  saveProfessor(professor.id,professor.is_saved)
                }
              } else {
                router.push('/login')
              }
              ...
              className={`ml-12 ${!disableButton && 'cursor-pointer'}`}>
